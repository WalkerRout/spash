...
void spatial_hasher_init(struct spatial_hasher *sh, float cell_size,
                         struct spashable intface, struct allocator *alloc);
void spatial_hasher_free(struct spatial_hasher *sh);
void spatial_hasher_build(struct spatial_hasher *sh, const void *items,
                          size_t items_len);
const void **spatial_hasher_query(const struct spatial_hasher *sh,
                                  const void *item,
